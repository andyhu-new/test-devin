...
df = pd.DataFrame({
    'Type': ['Project'] * 15,
    'Status': ['Completed', 'Red', 'Yellow', 'Green',  # Standard statuses
               'In Progress', 'On Hold', 'Blocked',  # Non-standard statuses
               'Red', 'Yellow', 'Green', 'Completed',
               'Pending Review', 'Not Started',  # More non-standard statuses
               'Red', 'Yellow'],
